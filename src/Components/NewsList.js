    ...
    <div className={`card card-${index + 1}`} key={article.article_id}>
      ...
      <div className="card-info">
        <div className="card-about">
          <p className="card-tag tag-news">NEWS</p>
        ...
        onClick={() => handleFavoriteToggle(article)}
         title="Save" className="cursor-pointer flex items-center fill-lime-400 bg-lime-950 hover:bg-lime-900 active:border active:border-lime-400 rounded-md duration-100 p-2"
        >
